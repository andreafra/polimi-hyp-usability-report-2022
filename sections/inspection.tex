...
\begin{itemize}
    \item \textbf{H1 Visibility of system status}\\
        ...
        \begin{figure}[!ht]
            \begin{minipage}{\linewidth}
                \centering
                \makebox[\textwidth][c]{\includegraphics[width=0.5\textwidth]{images/H1-1.png}}%
                \captionsetup{justification=centering}
        ...
        \begin{figure}[!ht]
            \begin{minipage}{\linewidth}
                \centering
                \makebox[\textwidth][c]{\includegraphics[width=1\textwidth]{images/H1-2.png}}%
                \captionsetup{justification=centering}
    ...
    \item \textbf{H2 Match between system and the real world}
        ...
        \begin{figure}[!ht]
            \begin{minipage}{\linewidth}
                \centering
                \makebox[\textwidth][c]{\includegraphics[width=1\textwidth]{images/H2-1.png}}%
                \captionsetup{justification=centering}
    ...
    \item \textbf{H4 Consistency and standards}\\
        ...
        \begin{figure}[!ht]
            \begin{minipage}{\linewidth}
                \centering
                \makebox[\textwidth][c]{\includegraphics[width=1\textwidth]{images/H4-1.png}}%
                \captionsetup{justification=centering}
        ...
        \begin{figure}[!ht]
            \begin{minipage}{\linewidth}
                \centering
                \makebox[\textwidth][c]{\includegraphics[width=1\textwidth]{images/H4-2.png}}%
                \captionsetup{justification=centering}
        ...
        \begin{figure}[!ht]
            \begin{minipage}{\linewidth}
                \centering
                \makebox[\textwidth][c]{\includegraphics[width=1\textwidth]{images/H4-3.png}}%
                \captionsetup{justification=centering}
    ...
    \item \textbf{H7 Flexibility and efficiency of use}\\
        ...
        \begin{figure}[!ht]
            \begin{minipage}{\linewidth}
                \centering
                \makebox[\textwidth][c]{\includegraphics[width=0.45\textwidth]{images/H7-1.png}}%
                \captionsetup{justification=centering}
    ...
    \item \textbf{H8 Aesthetic and minimalist design}\\
        ...
        \begin{figure}[!ht]
            \begin{minipage}[c]{0.5\textwidth}
                \centering
                \makebox[\textwidth][c]{\includegraphics[width=0.98\textwidth]{images/H8-1.png}}%
                \captionsetup{justification=centering}
                \caption{}
                \label{H8-1}
            \end{minipage}%
            \begin{minipage}[c]{0.5\textwidth}
                \centering
                \makebox[\textwidth][c]{\includegraphics[width=0.98\textwidth]{images/H8-2.png}}%
                \captionsetup{justification=centering}
                \caption{}
                \label{H8-2}
            \end{minipage}
    ...
    \item \textbf{H9 Help users recognize, diagnose and recover from errors}\\
        ...
        \begin{figure}[!ht]
            \begin{minipage}[c]{0.5\textwidth}
                \centering
                \makebox[\textwidth][c]{\includegraphics[width=0.98\textwidth]{images/H9-1.png}}%
                \captionsetup{justification=centering}
                \caption{}
                \label{H9-1}
            \end{minipage}
            \begin{minipage}[c]{0.5\textwidth}
                \centering
                \makebox[\textwidth][c]{\includegraphics[width=0.98\textwidth]{images/H9-2.png}}%
                \captionsetup{justification=centering}
                \caption{}
                \label{H9-2}
            \end{minipage}
...
\begin{itemize}
    ...
    \item \textbf{MN5 Landmarks}
        The only landmarks are the ones in the sticky header: an ``hamburger menu'' in the far right, a login button that's only intended for students and the search button, as well as a dropdown to select the website language. The login button is not particularly useful, and the menu button hides its content: while it's OK for navigation from a  mobile device, it's not very useful on a desktop.
